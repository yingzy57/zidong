...
#10月的预售订单中，付款时间在11月的订单拿出来，匹配定金金额，定金部分计入10月，尾款部分计入11月
#拿到10月预售订单
...
df_goodsorder=pd.concat([df_goodsorder_zhu,con])
...
data=pd.merge(df_goodsorder[['订单号','买家付款日期','买家付款年月','商品名称','商品规格','规格编码','商品规格ID','商品ID','商品实际成交金额','买家手机号','订单类型','大类']],df_goodslist_gbcf[['商品id（必填）','0级分类','1级分类','2级分类']],left_on=['商品ID'],right_on=['商品id（必填）'],how='left')
...
#按日期自营订单量
data_pivottwo_dingdan=data.pivot_table(values='订单号',index=['大类','0级分类','1级分类','2级分类'],columns='买家付款日期',aggfunc='count',fill_value=0)
data_pivotone_dingdan=data.pivot_table(values='订单号',index=['大类','0级分类','1级分类'],columns='买家付款日期',aggfunc='count',fill_value=0)
data_pivotzero_dingdan=data.pivot_table(values='订单号',index=['大类','0级分类'],columns='买家付款日期',aggfunc='count',fill_value=0)
data_pivot_dingdan=data.pivot_table(values='订单号',index=['大类'],columns='买家付款日期',aggfunc='count',fill_value=0)
#按月自营订单量
data_pivottwo_m_dingdan=data.pivot_table(values='订单号',index=['大类','0级分类','1级分类','2级分类'],columns='买家付款年月',aggfunc='count',fill_value=0)
data_pivotone_m_dingdan=data.pivot_table(values='订单号',index=['大类','0级分类','1级分类'],columns='买家付款年月',aggfunc='count',fill_value=0)
data_pivotzero_m_dingdan=data.pivot_table(values='订单号',index=['大类','0级分类'],columns='买家付款年月',aggfunc='count',fill_value=0)
data_pivot_m_dingdan=data.pivot_table(values='订单号',index=['大类'],columns='买家付款年月',aggfunc='count',fill_value=0)
